...
from resources.modules import downloader,userinfo

username     =  control.setting('Username')
password     =  control.setting('Password')
USERDATA     =  xbmc.translatePath(os.path.join('special://home/userdata',''))
ini          =  xbmc.translatePath(os.path.join('special://home/addons/'+userinfo.addon_id+'/resources/ivue',userinfo.addon_id+'.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/'+userinfo.addon_id+'/resources/ivue',userinfo.addon_id+'.zip'))
tmpini       =  xbmc.translatePath(os.path.join('special://home/userdata',''))
ivuetarget   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.ivueguide/resources/ini/'+userinfo.addon_id))
def iVueInt():
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create(userinfo.addon_name,"Copying ini",'', 'Please Wait')
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/'+userinfo.addon_id+'/resources/ivue','ivuesettings.xml'))
	iVueFold = xbmc.translatePath(os.path.join('special://home/addons/'+userinfo.addon_id+'/resources/ivue'))
	...
	if not xbmc.getCondVisibility('System.HasAddon(script.ivueguide)'):
		install('iVue','https://github.com/totaltec2014/ivue2/raw/master/script.ivueguide/script.ivueguide-3.0.9.zip')
	...
	dp = xbmcgui.DialogProgress()
	dp.create(userinfo.addon_name,"Copying DB",'', 'Please Wait')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create(userinfo.addon_name,"Installing iVue TV Guide...",'', 'Please Wait')
