...
def listcatchup():
	...
	for a in all:
		if '"tv_archive":1' in a:
			...
			tools.addDir(name.replace('ENT:','[COLOR white]ENT:[/COLOR]').replace('DOC:','[COLOR white]DOC:[/COLOR]').replace('MOV:','[COLOR white]MOV:[/COLOR]').replace('SSS:','[COLOR white]SSS[/COLOR]').replace('BTS:','[COLOR white]BTS:[/COLOR]').replace('TEST','[COLOR white]TEST[/COLOR]').replace('Install','[COLOR white]Install[/COLOR]').replace('24/7','[COLOR white]24/7[/COLOR]').replace('INT:','[COLOR white]INT:[/COLOR]').replace('DE:','[COLOR white]DE:[/COLOR]').replace('FR:','[COLOR white]FR:[/COLOR]').replace('PL:','[COLOR white]PL:[/COLOR]').replace('AR:','[COLOR white]AR:[/COLOR]').replace('LIVE:','[COLOR white]LIVE:[/COLOR]').replace('ES:','[COLOR white]ES:[/COLOR]').replace('IN:','[COLOR white]IN:[/COLOR]').replace('PK:','[COLOR white]PK:[/COLOR]'),'url',13,thumb,fanart,id)
